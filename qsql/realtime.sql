...
type_acronym AS ship_type, 
iso3 AS country, 
start_quay.description as FROM_QUAY,
start_berth.description as FROM_BERTH,
stop_quay.description as TO_QUAY,
stop_berth.description AS TO_BERTH,
...
agencies.description AS agency,
start_quay.description AS starting_quay,
start_berth.description AS starting_berth,
...
quays.description AS starting_quay,
berths.description AS starting_berth,
