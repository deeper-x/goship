...
func GetAllShippedGoods(idPortinformer string, idArrivalPrevisionState int, idDepartureState int) []map[string]string {
	...
	for rows.Next() {
		...
		tmpDict := map[string]string{
			...
			"length":                shipName.String,
			"width":                 shipName.String,
			"grossTonnage":          shipName.String,
			"netTonnage":            shipName.String,
			"agencyArrival":         shipName.String,
			"shipFlag":              shipName.String,
			"operation":             shipName.String,
			"shipType":              shipName.String,
			"shipSubtype":           shipName.String,
			"arrPrevDraftAft":       shipName.String,
			"arrPrevDraftFwd":       shipName.String,
			"depDraftAft":           shipName.String,
			"depDraftFwd":           shipName.String,
			"agencyArrivPrev":       shipName.String,
			"agencyDep":             shipName.String,
			"destinationPort":       shipName.String,
			"destinationCountry":    shipName.String,
			"lastPortOfCallName":    shipName.String,
			"lastPortOfCallCountry": shipName.String,
			"tsSighting":            shipName.String,
			"tsOutOfSight":          shipName.String,
			"shippedGoodsDetails":   shipName.String,
			"quantity":              shipName.String,
			"unit":                  shipName.String,
			"shippedGoodsGroup":     shipName.String,
			"shippedGoodsMacro":     shipName.String,
			"quay":                  shipName.String,
			"berth":                 shipName.String,
		}
